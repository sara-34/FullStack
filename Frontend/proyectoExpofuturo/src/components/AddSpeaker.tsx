...
interface SpeakerFormProps {
  ...
  onHideForm: () => void;
  editSpeaker: Speaker | null;
}

const AddSpeaker: React.FC<SpeakerFormProps> = ({ onAddSpeaker, onUpdateSpeaker, onHideForm, editSpeaker }) => {
    ...
    <div className='formulario-espacio'>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button type="submit" className="button">
          {editSpeaker ? 'Actualizar Ponente' : 'Crear Ponente'}
        </button>
      </form>
    </div>
  );
